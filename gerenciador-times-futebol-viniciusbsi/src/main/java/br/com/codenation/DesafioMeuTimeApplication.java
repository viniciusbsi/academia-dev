	...
	public Long buscarJogadorMaisVelho(Long idTime) {
		...
		for (Jogador jogadorl : this.lista_jogadores) {
			if (jogadorl.getIdTime().equals(idTime)) {
				...
				if ((jogadorl.getDataNascimento().isBefore(jogador.getDataNascimento()))
						|| (jogadorl.getDataNascimento().isEqual(jogador.getDataNascimento())
								&& jogadorl.getId() < jogador.getId())) {
					jogador = jogadorl;
				}
			}
		}
	...
	public Long buscarJogadorMaiorSalario(Long idTime) {
		...
		for (Jogador jogadorl : this.lista_jogadores) {
			if (jogadorl.getIdTime().equals(idTime)) {
				...
				if ((jogadorl.getSalario().compareTo(jogador.getSalario()) > 0)
						|| (jogadorl.getSalario().compareTo(jogador.getSalario()) == 0
								&& jogadorl.getId() < jogador.getId())) {
					jogador = jogadorl;
				}
			}
